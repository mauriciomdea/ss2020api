...
Participante.create(login: "nicolasb", password: "123456", password_confirmation: "123456", nome: "Nicolas Bertelloni", primeiro_dia_id: g3.id, segundo_dia_id: g3.id, organizacao: "FEMSA")
...
Participante.create(login: "camilaa", password: "123456", password_confirmation: "123456", nome: "Camila Amaral", primeiro_dia_id: g1.id, segundo_dia_id: g2.id, organizacao: "FEMSA")
...
Participante.create(login: "mariov", password: "123456", password_confirmation: "123456", nome: "Mario Veronezi", primeiro_dia_id: g2.id, segundo_dia_id: g2.id, organizacao: "SOLAR")
...
Participante.create(login: "alexandrem", password: "123456", password_confirmation: "123456", nome: "Alexandre Magno", primeiro_dia_id: g1.id, segundo_dia_id: g1.id, organizacao: "SOLAR")
...
Participante.create(login: "fabioa", password: "123456", password_confirmation: "123456", nome: "Fabio Acerbi", primeiro_dia_id: g1.id, segundo_dia_id: g2.id, organizacao: "SOLAR")
...
Participante.create(login: "renatob", password: "123456", password_confirmation: "123456", nome: "Renato Barbosa", primeiro_dia_id: g3.id, segundo_dia_id: g3.id, organizacao: "ANDINA")
...
Participante.create(login: "yulf", password: "123456", password_confirmation: "123456", nome: "Yul Fluvio", primeiro_dia_id: g1.id, segundo_dia_id: g2.id, organizacao: "BRASAL")
...
Participante.create(login: "alexandreb", password: "123456", password_confirmation: "123456", nome: "Alexandre Biagi", primeiro_dia_id: g2.id, segundo_dia_id: g2.id, organizacao: "UBERLANDIA")
...
Participante.create(login: "cristianob", password: "123456", password_confirmation: "123456", nome: "Cristiano Biagi", primeiro_dia_id: g1.id, segundo_dia_id: g3.id, organizacao: "SOROCABA")
...
Participante.create(login: "flavioc", password: "123456", password_confirmation: "123456", nome: "Flavio Camelier", primeiro_dia_id: g3.id, segundo_dia_id: g2.id, organizacao: "KO")
...
Participante.create(login: "luizc", password: "123456", password_confirmation: "123456", nome: "Luiz Phelipe Castro", primeiro_dia_id: g3.id, segundo_dia_id: g3.id, organizacao: "KO")
...
Participante.create(login: "marcelog", password: "123456", password_confirmation: "123456", nome: "Marcelo Gil", primeiro_dia_id: g1.id, segundo_dia_id: g3.id, organizacao: "KO")
...
Evento.create(titulo: "Palestrante Convidado", local: " PB13 Auditório", inicio: "2019-07-03 09:30:00", fim: "2019-07-03 11:00:00", palestrante: "Francisco Crespo", grupo: gg)
...
Evento.create(titulo: "Almoço", local: "PB 13 - Restaurante", inicio: "2019-07-03 12:15:00", fim: "2019-07-03 13:15:00", grupo: gg)
...
Evento.create(titulo: "Livre", local: nil, inicio: "2019-07-03 18:00:00", fim: "2019-07-03 20:00:00", grupo: gg)
...
Evento.create(titulo: "Almoço", local: "PB 13 - Restaurante", inicio: "2019-07-04 13:15:00", fim: "2019-07-04 14:15:00", grupo: gg)
